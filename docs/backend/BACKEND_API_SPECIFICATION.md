...
2. [API Endpoints](#2-api-endpoints)
   ...
   - 2.2 [User Session Management](#22-user-session-management)
   - 2.3 [Card Management](#23-card-management)
   - 2.4 [Reaction Management](#24-reaction-management)
   - 2.5 [Testing APIs](#25-testing--admin-apis)
...
| `user:alias_changed` | User changed alias | `{ board_id, old_alias, new_alias }` |
...
**User Session APIs**: 7 test cases covering join, heartbeat, alias updates

**Card APIs**: 33 test cases covering CRUD, relationships, limits, closed board behavior

**Reaction APIs**: 12 test cases covering add/remove, limits, aggregation

**Admin APIs**: 6 test cases covering authentication and data management

See detailed test matrices in [BACKEND_TEST_PLAN.md](./BACKEND_TEST_PLAN.md).
...
- [backend_task_list.md](./backend_task_list.md) - Implementation task list
